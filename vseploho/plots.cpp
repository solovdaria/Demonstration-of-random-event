...
/*
\brief Graphic builder

Builds 5 graphics of every ball's colour. Ox is number of step, Oy is a quantity of balls in the box
\param x Vector of step numbers
\param matr Matrix of vectors
*/
    ...
    ui(new Ui::plots)
{
    ...
    ui->widgetPlots->graph(1)->setPen(QPen(Qt::yellow));
    ui->widgetPlots->graph(2)->setPen(QPen(Qt::green));
    ui->widgetPlots->graph(3)->setPen(QPen(Qt::blue));
